...
**在线地址**：https://yichengxi.cn/

> 域名沿革：2026-09-18 由 `scott-portfolio.app.workbuddy.host` 迁至 `yichengxi.app.workbuddy.host`
> （旧域名已下线）；同日购入 **`yichengxi.cn`**。2026-09-19 将发布方式迁到 GitHub Pages，
> 站点不再依赖 WorkBuddy 会话发布。
...
- 实习、校园、教育与联系方式（含**简历 PDF 下载**、GitHub / LinkedIn 外链）
...
发布：GitHub Pages。绑定自定义域名 `yichengxi.cn`，`git push` 后自动更新。
